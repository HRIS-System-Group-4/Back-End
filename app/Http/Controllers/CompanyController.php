...
class CompanyController extends Controller
{
    ...
    /**
     * Mengaktifkan subscription selama 1 bulan
     */
    public function activateSubscription()
    {
        $user = Auth::user();

        if (!$user->is_admin || !$user->admin || !$user->admin->company_id) {
            return response()->json(['message' => 'Admin belum terhubung ke perusahaan.'], 400);
        }
        ...
        return response()->json([
            ...
            'expires_at' => $company->subscription_expires_at->toDateTimeString(),
        ]);
    }

    /**
     * Mengecek status subscription perusahaan
     */
    public function checkSubscriptionStatus()
    {
        ...
        $isValid = $company->subscription_active &&
